 ...
 */
class Manager extends MappedSuperclassPerson
{
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Survey", mappedBy="manager")
     */
    private $surveys;

    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Branch", mappedBy="manager")
     */
    private $branches;
    ...
    public function removeSurvey(Survey $survey): self
    {
        if ($this->surveys->contains($survey)) {
            ...
            if ($survey->getManager() === $this) {
                $survey->setManager(null);
            }
        }
